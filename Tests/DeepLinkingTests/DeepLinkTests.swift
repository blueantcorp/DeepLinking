...
//  DeepLinkinig
//
//  Created by emile on 07/04/2023.
//
...
class DeepLinkingTests: XCTestCase {
    ...
    struct DisplayMessageDeepLink: DeepLink {
        ...
        init(values: DeepLinkValues) {
            messageType = values.path["messageType"] as! String
            mustAccept = values.query["mustAccept"] as! Bool
            username = values.query["username"] as? String
        }
...
struct ADeepLink: DeepLink {
    ...
    public init(values _: DeepLinkValues) {}
}
...
struct IntDeepLink: DeepLink {
    ...
    public init(values: DeepLinkValues) {
        number = values.path["number"] as! Int
    }
...
struct BoolDeepLink: DeepLink {
    ...
    public init(values: DeepLinkValues) {
        boolean = values.path["boolean"] as! Bool
    }
...
struct DoubleDeepLink: DeepLink {
    ...
    public init(values: DeepLinkValues) {
        number = values.path["number"] as! Double
    }
...
struct StringDeepLink: DeepLink {
    ...
    public init(values: DeepLinkValues) {
        text = values.path["text"] as! String
    }
...
struct QueryRequiredIntDeepLink: DeepLink {
    ...
    public init(values: DeepLinkValues) {
        number = values.query["number"] as! Int
    }
